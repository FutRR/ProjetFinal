...
INSERT IGNORE INTO `avis` (`id`, `utilisateur_id`, `contenu`, `date_creation`, `note`) VALUES
	...
	(10, 1, '<p>test 2</p>', '2024-07-10 09:10:55', 2),
	(11, 1, '<p style="text-align: left;"><em><strong>test 3</strong></em></p>', '2024-07-10 09:11:14', 2),
	(12, 1, '<p>c<em><strong>oo</strong></em>l</p>', '2024-07-10 09:55:25', 5),
	(13, 1, '<p>testt</p>', '2024-07-11 10:54:40', 2),
	(14, 1, '<p>retest</p>', '2024-07-11 10:56:20', 3),
	(15, 1, '<p>yes</p>', '2024-07-11 10:58:32', 5),
	(16, 3, NULL, '2024-07-12 07:44:54', 5),
	(17, 1, 'test', '2024-07-26 08:51:28', 5);
...
-- Listage des données de la table projet_final_maximefutterer.doctrine_migration_versions : ~8 rows (environ)
INSERT IGNORE INTO `doctrine_migration_versions` (`version`, `executed_at`, `execution_time`) VALUES
	...
	('DoctrineMigrations\\Version20240718091011', '2024-07-18 09:10:31', 120),
	('DoctrineMigrations\\Version20240718122308', '2024-07-18 12:23:15', 62),
	('DoctrineMigrations\\Version20240718124132', '2024-07-18 12:41:44', 38),
	('DoctrineMigrations\\Version20240729125412', '2024-07-29 14:54:44', 259);

>>>>>>> 17f0107eda339120eb995ece2011db7e23d5e0e4
...
INSERT IGNORE INTO `etape` (`id`, `nom_etape`, `pdf`, `video`, `description`, `ordre`, `niveau_id`) VALUES
	...
	(7, 'Théorie', 'pdf/piano-facile.pdf', 'https://www.youtube.com/embed/', 'lorem ipsum blabla', 7, 2),
...
-- Listage des données de la table projet_final_maximefutterer.post : ~3 rows (environ)
INSERT IGNORE INTO `post` (`id`, `utilisateur_id`, `etape_id`, `contenu`, `date_creation`, `parent_id`) VALUES
	...
	(17, 1, 7, '<p>J\'ai pas trop compris &agrave; la page 2 du pdf, quelqu\'un peut m\'expliquer?</p>', '2024-07-18 13:18:13', NULL),
	(19, 1, 4, '<p>Ceci est un test</p>', '2024-07-23 09:53:31', NULL);
...
-- Listage des données de la table projet_final_maximefutterer.progression : ~9 rows (environ)
